...
export const registerFields = [
  ...
  { name: "email", label: "Email", type: "email", rules: { required: "Email is required" } },
  { name: "password", label: "Password", type: "password", rules: { required: "Password is required", minLength: { value: 6, message: "At least 6 characters" } } },
  { name: "battalion", label: "Battalion", type: "select", optionsKey: "battalions" },
];

// ✅ Profile Update Form (aligned with backend updateProfile fields)
export const profileFields = [
  ...
  { name: "fiveFoldGift", label: "5-Fold Ministry Gift", type: "text" },
  { name: "leadershipRoles", label: "Leadership Roles", type: "multi-select", optionsKey: "leadershipRoles" },
  { name: "education", label: "Education", type: "text" },
  { name: "jobStatus", label: "Job Status", type: "text" },
  { name: "incomeRange", label: "Income Range", type: "text" },
  { name: "purposeStatus", label: "Purpose Discovery Status", type: "text" },
